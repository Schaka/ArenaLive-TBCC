...
local function initFunc(frame)
	...
	frame:RegisterHandler(_G[prefix.."Name"], "NameText");
	...
	frame:RegisterHandler(_G[prefix.."HealthBarText"], "HealthBarText", nil, "HealthBar");
	frame:RegisterHandler(_G[prefix.."PowerBar"], "PowerBar", nil, addonName, "PartyFrames");
	frame:RegisterHandler(_G[prefix.."PowerBarText"], "PowerBarText", nil, "PowerBar");
	...
	frame:RegisterHandler(_G[prefix.."CastBar"], "CastBar", nil, _G[prefix.."CastBarIcon"], _G[prefix.."CastBarText"], nil, _G[prefix.."CastBarAnimation"], _G[prefix.."CastBarAnimationFadeOut"], true, addonName, "PartyFrames");
	...
	petFrame:RegisterHandler(_G[petPrefix.."HealthBarText"], "HealthBarText", nil, "HealthBar");
	petFrame:RegisterHandler(_G[petPrefix.."Portrait"], "Portrait", nil, _G[petPrefix.."PortraitTexture"],  _G[petPrefix.."PortraitThreeD"], petFrame);
	petFrame:RegisterHandler(_G[petPrefix.."Name"], "NameText");
	...
	targetFrame:RegisterHandler(_G[targetPrefix.."Portrait"], "Portrait", nil, _G[targetPrefix.."PortraitTexture"],  _G[targetPrefix.."PortraitThreeD"], targetFrame);
	targetFrame:RegisterHandler(_G[targetPrefix.."Name"], "NameText");
...
function ALUF_PartyFrames:OnEnable()
	...
	for memberFrame in _G.PartyFrame.PartyMemberFramePool:EnumerateActive() do
		...
		memberFrame:Hide()
		memberFrame:HookScript("OnShow", function() memberFrame:Hide() end)
	end
