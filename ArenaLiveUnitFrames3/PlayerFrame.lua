...
function ALUF_PlayerFrame:Initialise()
		...
		self:RegisterHandler(_G[prefix.."HealthBarText"], "HealthBarText", nil, "HealthBar");
		self:RegisterHandler(_G[prefix.."PowerBarText"], "PowerBarText", nil, "PowerBar");
		self:RegisterHandler(_G[prefix.."CastBar"], "CastBar", nil, _G[prefix.."CastBarIcon"], _G[prefix.."CastBarText"], nil, _G[prefix.."CastBarAnimation"], _G[prefix.."CastBarAnimationFadeOut"], true, addonName, "PlayerFrame");
		...
		self:RegisterHandler(_G[prefix.."PvPIcon"], "PvPIcon", nil, nil, nil, addonName, "PlayerFrame", _G[prefix.."PvPIconTexture"]);
